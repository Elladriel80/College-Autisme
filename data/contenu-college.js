  ...
  subjects: [
    ...
    },
    {
      ...
      lessons:[
        ...
        {
          id:"ang2", niveau:"5e", theme:"ecole-societe", cecrl:"A1", activites:["EOI","EE"],
          title:"Le verbe BE (am / is / are)",
          carte:{centre:"Le verbe BE", branches:[{titre:"I am", detail:"je suis (I'm)"},{titre:"he/she/it is", detail:"il/elle est (he's)"},{titre:"you/we/they are", detail:"tu es, nous sommes (you're)"},{titre:"Négatif", detail:"isn't, aren't, am not"},{titre:"Question", detail:"Am I? Is she? Are you?"}]},
          cours:"Le verbe <b>be</b> (être) se conjugue : <b>I am</b>, <b>you are</b>, <b>he/she/it is</b>, <b>we/you/they are</b>. Contractions : I'm, you're, he's, she's, it's, we're, they're. Négatif : <b>isn't</b>, <b>aren't</b> (am not). Question : on place be devant le sujet (<b>Are</b> you ready?). Exemple résolu : « Je suis fatigué » = <b>I am tired</b>.",
          questions:[
            {type:"qcm", q:"« I ___ a student. »", options:["am","is","are","be"], answer:0, explain:"I am.", indice:"Avec I, on emploie « am »."},
            {type:"qcm", q:"« She ___ happy. »", options:["is","am","are","be"], answer:0, explain:"he/she/it is.", indice:"Avec she : « is »."},
            {type:"qcm", q:"« They ___ at school. »", options:["are","is","am","be"], answer:0, explain:"they are.", indice:"Avec they : « are »."},
            {type:"qcm", q:"« You ___ my friend. »", options:["are","is","am","be"], answer:0, explain:"you are.", indice:"Avec you : « are »."},
            {type:"qcm", q:"Contraction de « I am » :", options:["I'm","Im","Iam","I're"], answer:0, explain:"I am se contracte en I'm.", indice:"Une apostrophe remplace le « a »."},
            {type:"qcm", q:"« He ___ ten years old. »", options:["is","are","am","be"], answer:0, explain:"he is.", indice:"Avec he : « is »."},
            {type:"qcm", q:"Négatif : « She ___ French. » (n'est pas)", options:["isn't","aren't","am not","don't"], answer:0, explain:"she isn't (is not).", indice:"Avec she : isn't."},
            {type:"qcm", q:"Question : « ___ you ready? »", options:["Are","Is","Am","Do"], answer:0, explain:"Are you ready?", indice:"Avec you : Are."},
            {type:"qcm", q:"« We ___ in the same class. »", options:["are","is","am","be"], answer:0, explain:"we are.", indice:"Avec we : « are »."},
            {type:"saisie", q:"Complète avec le verbe be : « It ___ a cat. »", answer:["is"], explain:"it is.", indice:"Avec it : « is »."},
            {type:"qcm", q:"Traduction de « Je suis fatigué. »", options:["I am tired.","I is tired.","I are tired.","I be tired."], answer:0, explain:"I am tired.", indice:"I + am."},
            {type:"vf", q:"« She are happy » est de l'anglais correct.", answer:false, explain:"Non : « She is happy ».", indice:"Avec she, on dit « is »."},
            {type:"qcm", q:"« Mary and Tom ___ friends. »", options:["are","is","am","be"], answer:0, explain:"Sujet pluriel : are.", indice:"Deux personnes : « are »."},
            {type:"qcm", q:"Contraction de « she is » :", options:["she's","shes","she're","sheis"], answer:0, explain:"she is se contracte en she's.", indice:"Apostrophe + s."},
            {type:"qcm", q:"Question : « ___ I late? »", options:["Am","Is","Are","Do"], answer:0, explain:"Am I late?", indice:"Avec I : Am."}
          ]
        },
        {
          id:"ang3", niveau:"5e", theme:"langages", cecrl:"A1-A2", activites:["CE","EE"],
          title:"HAVE GOT (la possession)",
          carte:{centre:"HAVE GOT", branches:[{titre:"Sens", detail:"avoir, posséder"},{titre:"I/you/we/they have got", detail:"I've got"},{titre:"he/she/it has got", detail:"she's got"},{titre:"Négatif", detail:"haven't / hasn't got"},{titre:"Question", detail:"Have you got? Has she got?"}]},
          cours:"<b>have got</b> signifie <b>avoir</b> (posséder). On dit <b>I/you/we/they have got</b> et <b>he/she/it has got</b>. Contractions : I've got, she's got. Négatif : <b>haven't got</b>, <b>hasn't got</b>. Question : <b>Have</b> you got...? <b>Has</b> she got...? Exemple résolu : « Elle a un chat » = <b>She has got a cat</b>.",
          questions:[
            {type:"qcm", q:"« I ___ got a dog. »", options:["have","has","am","do"], answer:0, explain:"I have got.", indice:"Avec I : have."},
            {type:"qcm", q:"« She ___ got a sister. »", options:["has","have","is","does"], answer:0, explain:"he/she/it has got.", indice:"Avec she : has."},
            {type:"qcm", q:"« have got » signifie :", options:["avoir (posséder)","être","aller","faire"], answer:0, explain:"avoir, posséder.", indice:"On parle de ce qu'on possède."},
            {type:"qcm", q:"« They ___ got a big house. »", options:["have","has","are","do"], answer:0, explain:"they have got.", indice:"Avec they : have."},
            {type:"qcm", q:"Négatif : « He ___ got a car. » (n'a pas)", options:["hasn't","haven't","isn't","doesn't"], answer:0, explain:"he hasn't got.", indice:"Avec he : hasn't."},
            {type:"qcm", q:"Question : « ___ you got a pen? »", options:["Have","Has","Are","Do"], answer:0, explain:"Have you got a pen?", indice:"Avec you : Have."},
            {type:"qcm", q:"« My brother ___ got blue eyes. »", options:["has","have","is","does"], answer:0, explain:"brother (il) has got.", indice:"3e personne : has."},
            {type:"saisie", q:"Complète : « We ___ got two cats. »", answer:["have"], explain:"we have got.", indice:"Avec we : have."},
            {type:"qcm", q:"Contraction de « I have got » :", options:["I've got","I'has got","I am got","I got"], answer:0, explain:"I've got.", indice:"have se contracte en 've."},
            {type:"qcm", q:"Traduction de « Elle a un chat. »", options:["She has got a cat.","She have got a cat.","She is a cat.","She got cat."], answer:0, explain:"She has got a cat.", indice:"she + has got."},
            {type:"vf", q:"« He have got a bike » est correct.", answer:false, explain:"Non : « He has got a bike ».", indice:"3e personne : has."},
            {type:"qcm", q:"Question : « ___ she got a phone? »", options:["Has","Have","Is","Does"], answer:0, explain:"Has she got a phone?", indice:"Avec she : Has."},
            {type:"qcm", q:"« You ___ got nice shoes. »", options:["have","has","are","do"], answer:0, explain:"you have got.", indice:"Avec you : have."},
            {type:"saisie", q:"Complète (3e personne) : « She ___ got long hair. »", answer:["has"], explain:"she has got.", indice:"Avec she : has."},
            {type:"qcm", q:"Contraction de « she has got » :", options:["she's got","shes got","she've got","she is got"], answer:0, explain:"she's got (she has).", indice:"has se contracte aussi en 's."}
          ]
        },
        {
          id:"ang4", niveau:"5e", theme:"voyages-migrations", cecrl:"A2", activites:["EOC","CE"],
          title:"Le présent en BE + -ING (present continuous)",
          carte:{centre:"BE + -ING", branches:[{titre:"Sens", detail:"action en cours maintenant"},{titre:"Forme", detail:"be (am/is/are) + verbe-ing"},{titre:"Exemple", detail:"I am reading"},{titre:"Orthographe", detail:"run → running, make → making"},{titre:"Différence", detail:"I play (habitude) / I am playing (maintenant)"}]},
          cours:"Le <b>présent en BE + -ING</b> (present continuous) décrit une action <b>en train de se passer maintenant</b>. Forme : <b>be</b> (am/is/are) + <b>verbe + -ing</b> (I am playing, she is reading). Orthographe : make → making (on enlève le e), run → running (on double la consonne). Exemple résolu : « Je regarde la télé (maintenant) » = <b>I am watching TV</b>.",
          questions:[
            {type:"qcm", q:"Le présent en BE+ING décrit :", options:["une action en cours maintenant","une habitude","le passé","le futur lointain"], answer:0, explain:"Une action en train de se faire.", indice:"Pense à « en ce moment »."},
            {type:"qcm", q:"« I ___ reading a book. »", options:["am","is","are","do"], answer:0, explain:"I am reading.", indice:"Avec I : am."},
            {type:"qcm", q:"« She is ___ . » (play)", options:["playing","plays","play","played"], answer:0, explain:"be + verbe-ing : playing.", indice:"Ajoute -ing au verbe."},
            {type:"qcm", q:"« They ___ watching TV. »", options:["are","is","am","do"], answer:0, explain:"they are watching.", indice:"Avec they : are."},
            {type:"qcm", q:"La forme est : be + ...", options:["verbe + -ing","base verbale","verbe + -s","verbe + -ed"], answer:0, explain:"be + verbe-ing.", indice:"Le verbe prend -ing."},
            {type:"saisie", q:"Complète : « He is ___ (run) . »", answer:["running"], explain:"run double le n : running.", indice:"On double la dernière consonne."},
            {type:"qcm", q:"« We ___ eating. »", options:["are","is","am","do"], answer:0, explain:"we are eating.", indice:"Avec we : are."},
            {type:"qcm", q:"« make » + ing =", options:["making","makeing","makking","maks"], answer:0, explain:"On enlève le e : making.", indice:"Le e final disparaît."},
            {type:"qcm", q:"Traduction de « Je regarde la télé (maintenant). »", options:["I am watching TV.","I watch TV.","I watching TV.","I am watch TV."], answer:0, explain:"I am watching TV.", indice:"be + verbe-ing."},
            {type:"vf", q:"« She is playing » décrit une action en cours.", answer:true, explain:"Oui : present continuous.", indice:"Action en train de se faire."},
            {type:"qcm", q:"« What ___ you doing? »", options:["are","is","am","do"], answer:0, explain:"What are you doing?", indice:"Avec you : are."},
            {type:"saisie", q:"Complète : « They are ___ (swim) . »", answer:["swimming"], explain:"swim double le m : swimming.", indice:"On double le m."},
            {type:"qcm", q:"« It ___ raining. »", options:["is","are","am","do"], answer:0, explain:"it is raining.", indice:"Avec it : is."},
            {type:"qcm", q:"« I play » (habitude) / « I ___ playing » (maintenant)", options:["am","do","have","will"], answer:0, explain:"I am playing (en cours).", indice:"be + verbe-ing."},
            {type:"qcm", q:"« write » + ing =", options:["writing","writeing","writting","writes"], answer:0, explain:"On enlève le e : writing.", indice:"Le e final disparaît."}
          ]
        },
        {
          id:"ang5", niveau:"5e", theme:"rencontres-cultures", cecrl:"A1-A2", activites:["EOI","EOC"],
          title:"CAN (capacité et permission)",
          carte:{centre:"CAN", branches:[{titre:"Sens", detail:"pouvoir, savoir"},{titre:"Forme", detail:"can + base verbale"},{titre:"Pas de -s, pas de to", detail:"she can swim"},{titre:"Négatif", detail:"can't / cannot"},{titre:"Question", detail:"Can you ...?"}]},
          cours:"<b>can</b> exprime la <b>capacité</b> (savoir faire) ou la <b>permission</b>. Forme : <b>can + base verbale</b>, sans « to » et sans -s à la 3e personne (I can swim, she can swim). Négatif : <b>can't</b> (cannot). Question : <b>Can</b> you help me? Exemple résolu : « Je sais nager » = <b>I can swim</b>.",
          questions:[
            {type:"qcm", q:"« I ___ swim. » (capacité)", options:["can","cans","can to","am can"], answer:0, explain:"I can swim.", indice:"can ne prend jamais de -s."},
            {type:"qcm", q:"Après « can », le verbe est :", options:["à la base verbale (sans to, sans -s)","au présent en -s","avec to","au passé"], answer:0, explain:"can + base verbale.", indice:"Pas de « to », pas de « -s »."},
            {type:"qcm", q:"« She ___ dance very well. »", options:["can","cans","can to","is can"], answer:0, explain:"she can dance.", indice:"can est invariable."},
            {type:"qcm", q:"Négatif : « He ___ swim. » (ne sait pas)", options:["can't","doesn't can","not can","cans not"], answer:0, explain:"he can't swim.", indice:"can + n't."},
            {type:"qcm", q:"Question : « ___ you help me? »", options:["Can","Do","Are","Is"], answer:0, explain:"Can you help me?", indice:"On place can devant le sujet."},
            {type:"qcm", q:"« can » exprime :", options:["la capacité ou la permission","le passé","la possession","le futur lointain"], answer:0, explain:"Capacité ou permission.", indice:"Savoir faire, ou avoir le droit."},
            {type:"qcm", q:"« We ___ play football. »", options:["can","cans","are can","can to"], answer:0, explain:"we can play.", indice:"can invariable + base."},
            {type:"vf", q:"« She can to sing » est correct.", answer:false, explain:"Non : « She can sing » (pas de « to »).", indice:"can n'est jamais suivi de « to »."},
            {type:"qcm", q:"Traduction de « Je sais nager. »", options:["I can swim.","I can to swim.","I cans swim.","I am swim."], answer:0, explain:"I can swim.", indice:"can + base verbale."},
            {type:"qcm", q:"« Can I go to the toilet? » demande :", options:["une permission","l'heure","une direction","un prix"], answer:0, explain:"C'est une demande de permission.", indice:"On demande le droit de faire quelque chose."},
            {type:"saisie", q:"Complète (capacité) : « They ___ speak English. »", answer:["can"], explain:"they can speak.", indice:"can est le même à toutes les personnes."},
            {type:"vf", q:"Après « can », on n'ajoute jamais -s (she can, pas she cans).", answer:true, explain:"Oui : can est invariable.", indice:"Pas de -s à la 3e personne."},
            {type:"qcm", q:"Négatif de « I can » :", options:["I can't (cannot)","I don't can","I cannot to","I am not can"], answer:0, explain:"I can't / I cannot.", indice:"can + n't."},
            {type:"qcm", q:"« He can ___ a bike. » (ride)", options:["ride","rides","riding","to ride"], answer:0, explain:"can + base : can ride.", indice:"Base verbale après can."},
            {type:"qcm", q:"« ___ she swim? »", options:["Can","Does","Is","Has"], answer:0, explain:"Can she swim?", indice:"can devant le sujet."}
          ]
        },
        {
          id:"ang6", niveau:"5e", theme:"ecole-societe", cecrl:"A1-A2", activites:["CE","EE"],
          title:"There is / There are (il y a)",
          carte:{centre:"There is / There are", branches:[{titre:"Sens", detail:"il y a"},{titre:"There is", detail:"+ singulier"},{titre:"There are", detail:"+ pluriel"},{titre:"Négatif", detail:"isn't / aren't"},{titre:"Question", detail:"Is there? Are there?"}]},
          cours:"<b>There is</b> / <b>There are</b> signifie <b>il y a</b>. On emploie <b>There is</b> + nom <b>singulier</b> (There is a book) et <b>There are</b> + nom <b>pluriel</b> (There are three pens). Négatif : there <b>isn't</b> / there <b>aren't</b>. Question : <b>Is there</b>...? <b>Are there</b>...? Exemple résolu : « Il y a deux chaises » = <b>There are two chairs</b>.",
          questions:[
            {type:"qcm", q:"« There ___ a book on the table. »", options:["is","are","am","be"], answer:0, explain:"Singulier : There is.", indice:"Un seul livre : is."},
            {type:"qcm", q:"« There ___ three pens. »", options:["are","is","am","be"], answer:0, explain:"Pluriel : There are.", indice:"Plusieurs stylos : are."},
            {type:"qcm", q:"« There is » / « There are » signifie :", options:["il y a","il est","il fait","il va"], answer:0, explain:"il y a.", indice:"On signale la présence de quelque chose."},
            {type:"qcm", q:"Avec un nom pluriel, on utilise :", options:["There are","There is","There am","There be"], answer:0, explain:"There are + pluriel.", indice:"Pluriel : are."},
            {type:"qcm", q:"« There ___ a cat in the garden. »", options:["is","are","am","be"], answer:0, explain:"Singulier : There is.", indice:"Un chat : is."},
            {type:"qcm", q:"« There ___ many students. »", options:["are","is","am","be"], answer:0, explain:"Pluriel : There are.", indice:"Beaucoup d'élèves : are."},
            {type:"qcm", q:"Négatif : « There ___ any milk. » (il n'y a pas)", options:["isn't","aren't","not is","don't"], answer:0, explain:"milk est indénombrable (singulier) : there isn't.", indice:"Avec « milk » : isn't."},
            {type:"qcm", q:"Question : « ___ there a problem? »", options:["Is","Are","Am","Do"], answer:0, explain:"Is there a problem?", indice:"Singulier : Is there."},
            {type:"saisie", q:"Complète (singulier) : « There ___ a dog. »", answer:["is"], explain:"There is a dog.", indice:"Un chien : is."},
            {type:"qcm", q:"Traduction de « Il y a deux chaises. »", options:["There are two chairs.","There is two chairs.","There have two chairs.","It is two chairs."], answer:0, explain:"There are two chairs.", indice:"Pluriel : There are."},
            {type:"vf", q:"« There are a book » est correct.", answer:false, explain:"Non : « There is a book » (singulier).", indice:"Un seul livre : is."},
            {type:"qcm", q:"« There ___ four seasons. »", options:["are","is","am","be"], answer:0, explain:"Pluriel : There are.", indice:"Quatre saisons : are."},
            {type:"qcm", q:"Question (pluriel) : « ___ there any apples? »", options:["Are","Is","Am","Do"], answer:0, explain:"Are there any apples?", indice:"Pluriel : Are there."},
            {type:"saisie", q:"Complète (pluriel) : « There ___ five days. »", answer:["are"], explain:"There are five days.", indice:"Cinq jours : are."},
            {type:"qcm", q:"« There ___ a teacher in the classroom. »", options:["is","are","am","be"], answer:0, explain:"Singulier : There is.", indice:"Un professeur : is."}
          ]
        },
        {
          id:"ang7", niveau:"4e", theme:"voyages-migrations", cecrl:"A2", activites:["CE","EE"],
          title:"Le prétérit simple (verbes réguliers et BE)",
          carte:{centre:"Le prétérit simple", branches:[{titre:"Sens", detail:"action passée et terminée"},{titre:"Réguliers", detail:"base + -ed (played)"},{titre:"BE", detail:"was / were"},{titre:"Négatif", detail:"didn't + base"},{titre:"Question", detail:"Did + sujet + base?"}]},
          cours:"Le <b>prétérit simple</b> (simple past) exprime une action <b>passée et terminée</b>. Les verbes <b>réguliers</b> prennent <b>-ed</b> (play → played, watch → watched). Le verbe <b>be</b> devient <b>was</b> (I/he/she/it) ou <b>were</b> (you/we/they). Négatif : <b>didn't</b> + base (he didn't play). Question : <b>Did</b> + sujet + base (Did you play?). Exemple résolu : « J'ai regardé un film » = <b>I watched a film</b>.",
          questions:[
            {type:"qcm", q:"Le prétérit exprime :", options:["une action passée et terminée","une action future","une habitude actuelle","une capacité"], answer:0, explain:"Le prétérit, c'est le passé révolu.", indice:"« passé » et fini."},
            {type:"qcm", q:"« I ___ football yesterday. » (play)", options:["played","play","plays","playing"], answer:0, explain:"play + ed : played.", indice:"Verbe régulier : -ed."},
            {type:"qcm", q:"Les verbes réguliers au prétérit prennent :", options:["-ed","-s","-ing","-er"], answer:0, explain:"Terminaison -ed.", indice:"Comme « played », « watched »."},
            {type:"qcm", q:"« She ___ TV last night. » (watch)", options:["watched","watch","watches","watching"], answer:0, explain:"watch + ed : watched.", indice:"-ed au prétérit."},
            {type:"qcm", q:"BE au prétérit : « I ___ happy. »", options:["was","were","am","is"], answer:0, explain:"I was.", indice:"Avec I : was."},
            {type:"qcm", q:"« They ___ at school. » (be, prétérit)", options:["were","was","are","be"], answer:0, explain:"they were.", indice:"Avec they : were."},
            {type:"qcm", q:"Négatif : « He ___ play. » (n'a pas joué)", options:["didn't","doesn't","wasn't","don't"], answer:0, explain:"he didn't play.", indice:"Au prétérit : didn't + base."},
            {type:"qcm", q:"Question : « ___ you visit London? »", options:["Did","Do","Was","Were"], answer:0, explain:"Did you visit...?", indice:"Question au prétérit : Did."},
            {type:"saisie", q:"Prétérit de « work » : « I ___ yesterday. »", answer:["worked"], explain:"work + ed : worked.", indice:"Verbe régulier : -ed."},
            {type:"qcm", q:"« We ___ in Paris last year. » (live)", options:["lived","live","lives","living"], answer:0, explain:"live + d : lived.", indice:"Le verbe finit déjà par e : on ajoute juste -d."},
            {type:"vf", q:"« She was tired » est au prétérit (verbe be).", answer:true, explain:"Oui : was = passé de be.", indice:"was = était."},
            {type:"qcm", q:"« You ___ late. » (be, prétérit)", options:["were","was","are","be"], answer:0, explain:"you were.", indice:"Avec you : were."},
            {type:"qcm", q:"Traduction de « J'ai regardé un film. »", options:["I watched a film.","I watch a film.","I am watching a film.","I watched film."], answer:0, explain:"I watched a film.", indice:"watch + ed, et n'oublie pas « a »."},
            {type:"saisie", q:"Prétérit de « open » : « He ___ the door. »", answer:["opened"], explain:"open + ed : opened.", indice:"Verbe régulier : -ed."},
            {type:"qcm", q:"Négatif : « They ___ come. » (prétérit)", options:["didn't","don't","weren't","doesn't"], answer:0, explain:"they didn't come.", indice:"didn't + base verbale."}
          ]
        },
        {
          id:"ang8", niveau:"4e", theme:"langages", cecrl:"A2", activites:["CE","EE"],
          title:"Les verbes irréguliers au prétérit",
          carte:{centre:"Verbes irréguliers (prétérit)", branches:[{titre:"Pas de -ed", detail:"une forme à apprendre"},{titre:"go → went", detail:"aller"},{titre:"have → had", detail:"avoir"},{titre:"see → saw", detail:"voir"},{titre:"make → made", detail:"faire/fabriquer"}]},
          cours:"Certains verbes sont <b>irréguliers</b> au prétérit : ils ne prennent pas -ed, leur forme est à <b>apprendre par coeur</b>. Exemples : go → <b>went</b>, have → <b>had</b>, see → <b>saw</b>, do → <b>did</b>, make → <b>made</b>, take → <b>took</b>, eat → <b>ate</b>, come → <b>came</b>, get → <b>got</b>. Exemple résolu : « Je suis allé à l'école » = <b>I went to school</b>.",
          questions:[
            {type:"qcm", q:"Prétérit de « go » :", options:["went","goed","gone","going"], answer:0, explain:"go → went.", indice:"Forme irrégulière à connaître."},
            {type:"qcm", q:"Prétérit de « have » :", options:["had","haved","has","having"], answer:0, explain:"have → had.", indice:"Forme irrégulière."},
            {type:"qcm", q:"Prétérit de « see » :", options:["saw","seed","seen","sees"], answer:0, explain:"see → saw.", indice:"Attention : « seen » est le participe passé."},
            {type:"qcm", q:"Prétérit de « make » :", options:["made","maked","make","making"], answer:0, explain:"make → made.", indice:"Forme irrégulière."},
            {type:"qcm", q:"« I ___ to school yesterday. » (go)", options:["went","goed","go","gone"], answer:0, explain:"go → went.", indice:"Prétérit irrégulier de go."},
            {type:"qcm", q:"Prétérit de « eat » :", options:["ate","eated","eaten","eats"], answer:0, explain:"eat → ate.", indice:"« eaten » est le participe passé."},
            {type:"qcm", q:"« She ___ a cake. » (make)", options:["made","maked","make","makes"], answer:0, explain:"make → made.", indice:"Forme irrégulière."},
            {type:"qcm", q:"Prétérit de « take » :", options:["took","taked","taken","takes"], answer:0, explain:"take → took.", indice:"« taken » est le participe passé."},
            {type:"saisie", q:"Prétérit de « come ».", answer:["came"], explain:"come → came.", indice:"Forme irrégulière en -ame."},
            {type:"qcm", q:"« We ___ a film last night. » (see)", options:["saw","seed","seen","see"], answer:0, explain:"see → saw.", indice:"Prétérit irrégulier de see."},
            {type:"vf", q:"Les verbes irréguliers ne prennent pas -ed au prétérit.", answer:true, explain:"Oui : leur forme est particulière.", indice:"Il faut les mémoriser."},
            {type:"qcm", q:"Prétérit de « get » :", options:["got","getted","gotten","gets"], answer:0, explain:"get → got.", indice:"Forme irrégulière."},
            {type:"saisie", q:"Prétérit de « have ».", answer:["had"], explain:"have → had.", indice:"Forme irrégulière."},
            {type:"qcm", q:"« They ___ pizza. » (eat)", options:["ate","eated","eat","eaten"], answer:0, explain:"eat → ate.", indice:"Prétérit irrégulier de eat."},
            {type:"qcm", q:"Prétérit de « do » :", options:["did","doed","done","does"], answer:0, explain:"do → did.", indice:"« done » est le participe passé."}
          ]
        },
        {
          id:"ang9", niveau:"4e", theme:"ecole-societe", cecrl:"A2", activites:["EOC","EE"],
          title:"Le futur : will et be going to",
          carte:{centre:"Le futur (will / be going to)", branches:[{titre:"will + base", detail:"décision, prédiction"},{titre:"Contraction", detail:"I'll, négatif won't"},{titre:"be going to + base", detail:"intention, projet"},{titre:"Exemple", detail:"I'm going to study"},{titre:"Sans « to » après will", detail:"I will go (pas to go)"}]},
          cours:"Pour parler du <b>futur</b> : <b>will + base verbale</b> (décision, prédiction : I will help, it will rain ; contraction <b>'ll</b>, négatif <b>won't</b>). Et <b>be going to + base</b> (intention, projet : I'm going to study). Après <b>will</b>, pas de « to ». Exemple résolu : « Il va pleuvoir » = <b>It is going to rain</b>.",
          questions:[
            {type:"qcm", q:"« I ___ help you. » (décision)", options:["will","am","do","would"], answer:0, explain:"I will help.", indice:"will pour une décision."},
            {type:"qcm", q:"Après « will », le verbe est :", options:["à la base verbale","au présent en -s","avec to","au prétérit"], answer:0, explain:"will + base.", indice:"Pas de « to », pas de « -s »."},
            {type:"qcm", q:"« It ___ rain tomorrow. » (prédiction)", options:["will","is","does","has"], answer:0, explain:"It will rain.", indice:"will pour une prédiction."},
            {type:"qcm", q:"Contraction de « I will » :", options:["I'll","Iwill","I'will","Ill"], answer:0, explain:"I will → I'll.", indice:"Apostrophe + ll."},
            {type:"qcm", q:"Négatif de « will » :", options:["won't","willn't","don't will","not will"], answer:0, explain:"will not → won't.", indice:"Forme contractée particulière."},
            {type:"qcm", q:"« be going to » exprime :", options:["une intention, un projet","le passé","une habitude","une capacité"], answer:0, explain:"Une intention ou un projet.", indice:"Ce qu'on a prévu de faire."},
            {type:"qcm", q:"« I'm going to ___ tonight. » (study)", options:["study","studying","studies","studied"], answer:0, explain:"going to + base : study.", indice:"Base verbale après « going to »."},
            {type:"qcm", q:"« She ___ going to travel. »", options:["is","are","am","will"], answer:0, explain:"she is going to.", indice:"Avec she : is."},
            {type:"saisie", q:"Complète (intention) : « We are going to ___ (visit) Rome. »", answer:["visit"], explain:"going to + base : visit.", indice:"Base verbale."},
            {type:"vf", q:"« I will to go » est correct.", answer:false, explain:"Non : « I will go » (pas de « to » après will).", indice:"will n'est jamais suivi de « to »."},
            {type:"qcm", q:"Traduction de « Il va pleuvoir. »", options:["It is going to rain.","It will to rain.","It going to rain.","It is go to rain."], answer:0, explain:"It is going to rain.", indice:"be going to + base."},
            {type:"qcm", q:"« They ___ come tomorrow. » (will)", options:["will","are","do","have"], answer:0, explain:"they will come.", indice:"will pour le futur."},
            {type:"qcm", q:"« I'm going to » est suivi de :", options:["la base verbale","un verbe en -ing","un verbe en -s","un nom seul"], answer:0, explain:"going to + base verbale.", indice:"Comme « going to play »."},
            {type:"qcm", q:"« What ___ you do? » (futur, will)", options:["will","are","do","would"], answer:0, explain:"What will you do?", indice:"will pour le futur."},
            {type:"qcm", q:"Négatif : « He ___ help. » (futur)", options:["won't","doesn't","isn't","not"], answer:0, explain:"he won't help.", indice:"will not → won't."}
          ]
        },
        {
          id:"ang10", niveau:"4e", theme:"rencontres-cultures", cecrl:"A2", activites:["CE","EOC"],
          title:"Comparatifs et superlatifs",
          carte:{centre:"Comparatifs et superlatifs", branches:[{titre:"Adjectif court", detail:"-er / the -est (bigger)"},{titre:"Adjectif long", detail:"more / the most"},{titre:"Comparer", detail:"... than ..."},{titre:"good", detail:"better / the best"},{titre:"bad", detail:"worse / the worst"}]},
          cours:"Pour <b>comparer</b> : adjectif <b>court</b> (1 syllabe) → <b>-er</b> et superlatif <b>the -est</b> (big → bigger → the biggest). Adjectif <b>long</b> → <b>more</b> et <b>the most</b> (interesting → more interesting → the most interesting). On compare deux choses avec <b>than</b> (faster than). Irréguliers : good → <b>better</b> → the best ; bad → <b>worse</b> → the worst.",
          questions:[
            {type:"qcm", q:"Comparatif de « big » :", options:["bigger","more big","biggest","bigest"], answer:0, explain:"Court : big → bigger (on double le g).", indice:"Adjectif court : -er."},
            {type:"qcm", q:"Superlatif de « tall » :", options:["the tallest","the most tall","more tall","tallest more"], answer:0, explain:"Court : the tallest.", indice:"the + adjectif + est."},
            {type:"qcm", q:"Pour un adjectif long, le comparatif est :", options:["more + adjectif","adjectif + er","the + adjectif","most + adjectif"], answer:0, explain:"more + adjectif (more interesting).", indice:"On n'ajoute pas -er aux longs adjectifs."},
            {type:"qcm", q:"Comparatif de « interesting » :", options:["more interesting","interestinger","most interesting","interesting more"], answer:0, explain:"Long : more interesting.", indice:"Adjectif long : « more »."},
            {type:"qcm", q:"« A car is ___ than a bike. » (fast)", options:["faster","more fast","fastest","fast"], answer:0, explain:"Court : faster than.", indice:"-er + than."},
            {type:"qcm", q:"On compare deux choses avec le mot :", options:["than","that","then","of"], answer:0, explain:"... -er than ...", indice:"« plus ... que » se dit « ... than »."},
            {type:"qcm", q:"Comparatif de « good » :", options:["better","gooder","more good","best"], answer:0, explain:"Irrégulier : good → better.", indice:"Forme particulière à retenir."},
            {type:"qcm", q:"Superlatif de « good » :", options:["the best","the goodest","the better","the most good"], answer:0, explain:"good → the best.", indice:"Irrégulier."},
            {type:"qcm", q:"Comparatif de « bad » :", options:["worse","badder","more bad","worst"], answer:0, explain:"Irrégulier : bad → worse.", indice:"Forme particulière."},
            {type:"saisie", q:"Comparatif de « small » (un seul mot).", answer:["smaller"], explain:"small → smaller.", indice:"Adjectif court : -er."},
            {type:"qcm", q:"Superlatif de « big » :", options:["the biggest","the most big","the bigest","biggest more"], answer:0, explain:"the biggest (on double le g).", indice:"the + big + gest."},
            {type:"vf", q:"« She is more tall than me » est correct.", answer:false, explain:"Non : tall est court → « taller than me ».", indice:"Adjectif court : -er, pas « more »."},
            {type:"qcm", q:"« This is ___ film of the year. » (good, superlatif)", options:["the best","the goodest","better","the most good"], answer:0, explain:"good → the best.", indice:"Superlatif irrégulier."},
            {type:"qcm", q:"« English is ___ than maths (pour moi). » (easy)", options:["easier","more easy","easiest","easyer"], answer:0, explain:"easy → easier (y devient i).", indice:"Le y final devient i, puis -er."},
            {type:"qcm", q:"Superlatif de « interesting » :", options:["the most interesting","the interestingest","more interesting","the interesting most"], answer:0, explain:"Long : the most interesting.", indice:"the most + adjectif long."}
          ]
        },
        {
          id:"ang11", niveau:"4e", theme:"ecole-societe", cecrl:"A2", activites:["EOC","CE"],
          title:"Les adverbes de fréquence",
          carte:{centre:"Adverbes de fréquence", branches:[{titre:"always", detail:"toujours"},{titre:"usually / often", detail:"d'habitude / souvent"},{titre:"sometimes", detail:"parfois"},{titre:"never", detail:"jamais"},{titre:"Place", detail:"avant le verbe, après be"}]},
          cours:"Les <b>adverbes de fréquence</b> disent à quelle fréquence on fait quelque chose : <b>always</b> (toujours), <b>usually</b> (d'habitude), <b>often</b> (souvent), <b>sometimes</b> (parfois), <b>never</b> (jamais). Ils se placent <b>avant le verbe principal</b> (I <b>always</b> play) mais <b>après</b> le verbe <b>be</b> (She is <b>never</b> late). Exemple résolu : « Je ne suis jamais en retard » = <b>I am never late</b>.",
          questions:[
            {type:"qcm", q:"« always » signifie :", options:["toujours","jamais","parfois","souvent"], answer:0, explain:"always = toujours.", indice:"100 % du temps."},
            {type:"qcm", q:"« never » signifie :", options:["jamais","toujours","souvent","parfois"], answer:0, explain:"never = jamais.", indice:"0 % du temps."},
            {type:"qcm", q:"« often » signifie :", options:["souvent","jamais","toujours","rarement"], answer:0, explain:"often = souvent.", indice:"Assez fréquemment."},
            {type:"qcm", q:"« sometimes » signifie :", options:["parfois","toujours","jamais","souvent"], answer:0, explain:"sometimes = parfois.", indice:"De temps en temps."},
            {type:"qcm", q:"Les adverbes de fréquence se placent :", options:["avant le verbe principal","toujours à la fin","avant le sujet","après le COD seulement"], answer:0, explain:"Avant le verbe principal (I always play).", indice:"Juste avant le verbe d'action."},
            {type:"qcm", q:"Ordre correct :", options:["I always play tennis.","I play always tennis.","Always I play tennis.","I play tennis always today."], answer:0, explain:"L'adverbe est avant le verbe : I always play.", indice:"always devant le verbe."},
            {type:"qcm", q:"Avec le verbe BE, l'adverbe se place :", options:["après be","avant be","à la fin","avant le sujet"], answer:0, explain:"She is never late (après be).", indice:"Avec be, l'adverbe vient juste après."},
            {type:"qcm", q:"« She is ___ late. » (jamais)", options:["never","ever","not never","no"], answer:0, explain:"She is never late.", indice:"« jamais » = never."},
            {type:"qcm", q:"Traduction de « Je ne suis jamais en retard. »", options:["I am never late.","I never am late.","I am late never.","I not late never."], answer:0, explain:"I am never late (never après be).", indice:"never juste après « am »."},
            {type:"vf", q:"« I never eat meat » signifie « Je ne mange jamais de viande ».", answer:true, explain:"Oui : never = jamais.", indice:"never traduit « jamais »."},
            {type:"qcm", q:"« usually » signifie :", options:["d'habitude","jamais","une fois","hier"], answer:0, explain:"usually = d'habitude.", indice:"La plupart du temps."},
            {type:"qcm", q:"Ordre correct :", options:["He sometimes watches TV.","He watches sometimes TV.","Sometimes he watch TV.","He watch sometimes TV."], answer:0, explain:"sometimes avant le verbe : He sometimes watches TV.", indice:"L'adverbe devant le verbe."},
            {type:"qcm", q:"« always » se place ___ le verbe principal.", options:["avant","après","loin de","jamais près de"], answer:0, explain:"Avant le verbe principal.", indice:"Juste devant le verbe d'action."},
